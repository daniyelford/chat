<template>
  ...
  <button v-if="placeStore?.allPlaces?.length>0" @click="mapExpanded=!mapExpanded" class="layout-toggle">
  ...
  <div class="containers" v-if="placeStore?.allPlaces?.length>0" :class="{ expanded: mapExpanded }">
    <div class="category">
